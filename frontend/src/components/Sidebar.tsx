...
const menuItems: MenuItem[] = [
  {
    ...
    path: "/role-dashboard",
    icon: "🔐",
    roles: ["admin", "bm", "unit_manager", "agency_manager", "agent"],
  },
  {
    name: "Dashboard",
    path: "/dashboard",
