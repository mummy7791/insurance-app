...
const schema=new mongoose.Schema({
 ...
 requestType:{type:String,enum:["Nominee Change","Address Change","Contact Update","Bank Update","Cover Enhancement","Policy Loan","Partial Withdrawal","Surrender Policy","Policy Revival","Free-Look Cancellation","Other"],required:true},
 currentValue:{type:String,default:""}, requestedValue:{type:String,required:true,trim:true},
 nomineeChange:{nominees:{type:[mongoose.Schema.Types.Mixed],default:[]},documentVerified:{type:Boolean,default:false},effectiveDate:{type:Date,default:null}},
 ...
 cancellationRequest:{policyStartDate:{type:Date,default:null},freeLookLastDate:{type:Date,default:null},freeLookDays:{type:Number,default:0},paidPremiumAmount:{type:Number,default:0},approvedRefundAmount:{type:Number,default:0},refundStatus:{type:String,enum:["Not Applicable","Pending","Approved","Refunded","Rejected"],default:"Not Applicable"},refundedAt:{type:Date,default:null}},
